...
* Update the package name of the Android plugin:
  ...
  * Make sure that `package` at the top of [`GodotAndroidPlugin.kt`](plugin/src/main/java/org/godotengine/plugin/android/healthconnectplugin/GodotAndroidPlugin.kt)
